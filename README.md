...
- **Обновление** — проверка новой версии и обновление программы из GitHub, история версий из `CHANGELOG.md`
...
| **Обновление** | проверка версии и обновление программы, история версий из CHANGELOG.md |
