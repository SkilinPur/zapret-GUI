...
class HelpTab(QWidget):
    ...
    def _build_ui(self):
        ...
        ql.addWidget(_step(
            1,
            "Скачать зависимости — вкладка «Стратегии» → кнопка "
            "«Скачать/обновить зависимости». Скачиваются nfqws и файлы стратегий.",
        ))
        ql.addWidget(_step(
            2,
        ...
        tl.addWidget(_bullet(
            "<b>Стратегии</b> — список файлов .bat, скачивание/обновление "
            "зависимостей.",
        ))
        tl.addWidget(_bullet(
        ...
        tl2.addWidget(_bullet(
            "Проверьте, что зависимости скачаны (вкладка «Стратегии»).",
        ))
        tl2.addWidget(_bullet(
